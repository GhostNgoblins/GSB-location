 ...
 */
final class Version20200407115011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE locataire (id INT NOT NULL, banque_id INT DEFAULT NULL, appartements_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C47CF6EB37E080D9 ON locataire (banque_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C47CF6EBCC24952C ON locataire (appartements_id)');
        ...
        $this->addSql('CREATE TABLE visite (id SERIAL NOT NULL, client_id INT DEFAULT NULL, appartement_id INT NOT NULL, date_visite DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE locataire ADD CONSTRAINT FK_C47CF6EBCC24952C FOREIGN KEY (appartements_id) REFERENCES appartement (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE locataire DROP CONSTRAINT FK_C47CF6EBCC24952C');
